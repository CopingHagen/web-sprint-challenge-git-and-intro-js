...
function addArtist(array, name, years, genre , nationality, bio) {
  let newArray = [];
  let newObject = {name, years, genre, nationality, bio};
...
console.log('task 6', addArtist(artists, 'John Doe', '1988-2022', 'Full Stack Development', 'African American', 'I have a background in customer service at a Big Retail Chain. I am attending BloomTech to become a Frontend Developer.'))
